...
{
    // Burada animasyon kontrolü için bir bool deðiþkeni atadýk ve ona true false vererek hareket ettirdik.
    bool hareketlimi;

    //Hangi Yöne gidecegini kararlastirmasi icin bir vector3 tanýmladýk.
    Vector3 hangiYon;

    //Quaternion metodu
    Quaternion donusYon;

    //Animatorden anim adli degisken tanýmladik
    Animator anim;
    private void Awake()
    {
